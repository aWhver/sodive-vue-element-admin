  ...
  <div>
    <el-container>
      <el-header>
        <div class="filter-container">
          ...
          <div class="filter-item">
            <el-button type="primary" icon="el-icon-circle-plus" @click="agentVisible = true">新增合伙人</el-button>
          </div>
        </div>
      </el-header>
      <el-main>
        <el-table :data="list" style="width:100%" border v-loading="loading" element-loading-text="小主,我需要时间...">
          ...
          <el-table-column label="操作" width="200px" align="center">
            <template slot-scope="scope">
              ...
              <el-button type="info" @click="cancelVisible = true">注销</el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-main>
    ...
    <el-dialog title="新增合伙人" :visible.sync='agentVisible' width="350px">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="agentVisible = false">确 定</el-button>
      </span>
    </el-dialog>
    <!-- 合伙人国际修改弹窗 -->
    <el-dialog title="修改合伙人国籍信息" :visible.sync="modifyVisible" width="350px">
      <div class="input-item">
        <el-input placeholder="输入国籍"></el-input>
      </div>
      <span slot="footer" class="dialog-footer">
...
<script>
  import { getAgentList } from 'api/userManage/agent'
